class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:email, :password, :password_confirmation, :dni, :first_name, :last_name, :phone, :address, :role, :positive_balance, dogs_attributes: [:id, :photo, :first_name, :last_name, :breed, :color, :sex, :birthday])
    end
